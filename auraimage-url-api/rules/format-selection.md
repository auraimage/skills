...
<img src="https://auraimage.io/slug/photo.jpg?w=800" alt="..." />
```
...
<meta property="og:image" content="https://auraimage.io/slug/photo.jpg?w=1200&fmt=jpeg" />
```
...
<img src="https://auraimage.io/slug/banner.jpg?w=600&fmt=jpeg" />
```

**`<picture>` srcsets** — here you explicitly list formats per `<source>`, so `fmt` is correct:

```tsx
<source type="image/jxl" srcSet="https://auraimage.io/slug/photo.jpg?w=800&fmt=jxl 800w" />
<source type="image/avif" srcSet="https://auraimage.io/slug/photo.jpg?w=800&fmt=avif 800w" />
```
