...
<picture>
  <source
    type="image/avif"
    srcSet="
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=400&fmt=avif 400w,
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=800&fmt=avif 800w,
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=1200&fmt=avif 1200w
    "
  ...
  <source
    type="image/webp"
    srcSet="
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=400&fmt=webp 400w,
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=800&fmt=webp 800w,
      https://cdn.auraimage.ai/{projectName}/hero.jpg?w=1200&fmt=webp 1200w
    "
    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 1200px"
  />
  <img
    src="https://cdn.auraimage.ai/{projectName}/hero.jpg?w=1200"
    alt="Hero"
    className="w-full"
    width={1200}
    height={800}
...
```tsx
<picture>
  <source type="image/avif" srcSet="https://cdn.auraimage.ai/{projectName}/product.jpg?w=400&h=400&fit=cover&fmt=avif 400w" />
  <source type="image/webp" srcSet="https://cdn.auraimage.ai/{projectName}/product.jpg?w=400&h=400&fit=cover&fmt=webp 400w" />
  <img
    src="https://cdn.auraimage.ai/{projectName}/product.jpg?w=400&h=400&fit=cover"
    alt="Product"
    width={400}
    height={400}
    loading="lazy"
...
```css
.hero {
  background-image: url('https://cdn.auraimage.ai/{projectName}/hero.jpg?w=1920&q=75');
}
```
